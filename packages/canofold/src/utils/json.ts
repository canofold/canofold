...
function validateJsonValue(value: unknown, seen: WeakSet<object>): value is CanofoldJsonValue {
...
export function assertJsonValue(value: unknown, label: string): asserts value is CanofoldJsonValue {
