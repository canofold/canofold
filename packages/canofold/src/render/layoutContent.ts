import type { MarkdownLabels } from '@canofold/markdown'
import { CANOFOLD_MARKDOWN_ELEMENT_GROUP_IDS } from '../config/constants'
import {
  type CanofoldLayoutLabels,
  type CanofoldLocaleMessages,
  type CanofoldMarkdownElementGroupId,
  type CanofoldNotFoundMessages,
  type CanofoldQuickActionMessages
} from '../config/types'

export const MARKDOWN_ELEMENT_GROUP_IDS = CANOFOLD_MARKDOWN_ELEMENT_GROUP_IDS
export type MarkdownElementGroupId = CanofoldMarkdownElementGroupId
...
export interface LayoutContent {
  labels: CanofoldLayoutLabels
  brandTagline: string
  markdownElementGroups: MarkdownElementGroup[]
  quickActions: CanofoldQuickActionMessages
}
...
} satisfies Record<'zh' | 'en', CanofoldNotFoundMessages>
...
): CanofoldLocaleMessages | undefined {
