...
export function resolveRedirects(config: CanofoldConfig, graph: ContentGraph) {
...
export async function writeRedirects(cwd: string, config: CanofoldConfig, graph: ContentGraph) {
