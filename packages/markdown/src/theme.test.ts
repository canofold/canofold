...
describe('Markdown theme contract', () => {
  it('completes partial semantic tokens without exposing component internals', () => {
    ...
    expect(declarations).toContain('--df-reading-width: 70ch;')
    expect(declarations).toContain('--df-body-font-size: 1.125rem;')
    expect(declarations).toContain('--df-body-line-height: 1.8;')
    expect(declarations).toContain('--df-heading-line-height: 1.2;')
    expect(declarations).toContain('--df-heading-5-size: 1.15rem;')
    expect(declarations).toContain('--df-shadow-raised: 0 1px 2px #0003;')
    expect(declarations).toContain('--df-radius-lg: 8px;')
    expect(declarations).not.toContain('--df-text-base:')
    expect(declarations).not.toContain('--df-radius-xl:')
